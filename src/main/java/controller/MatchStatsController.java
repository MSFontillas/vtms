...
import main.java.view.MatchStatsView;
...
public class MatchStatsController {
    ...
    private final MatchStatsView matchStatsView;
    ...
    private void updateMatchStats() throws SQLException {
        ...
        MatchStats updatedStats = matchStatsView.getUpdateMatchStatsInput(existingStats);
        updatedStats.setStatID(statId);
        updatedStats.setMatchID(existingStats.getMatchID());
        updatedStats.setPlayerID(existingStats.getPlayerID());
